...
export function CertificationPage() {
  ...
  const certificationApplications = applications.filter(
    (app) => app.type === Programs.CERTIFICATION
  );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Kelola pengajuan sertifikasi untuk UMKM
        </p>
      </div>
              ...
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="outline">CERT-{application.id}</Badge>
                  </div>
      ...
      {filteredApplications.length === 0 && (
        <Card>
          <CardContent className="p-6 text-center">
            <p className="text-muted-foreground">
              Tidak ada pengajuan sertifikasi yang ditemukan.
            </p>
          </CardContent>
        </Card>
      )}
